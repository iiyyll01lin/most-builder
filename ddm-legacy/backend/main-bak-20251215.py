...
ACTION_SKILL_MAPPING = {
    # G - Grasp actions
    "抓取": {"code": "G", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "拿取": {"code": "G", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "轻拍": {"code": "G", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "抓握": {"code": "G", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    
    # M - Move/Controlled actions
    "按动按钮": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3, "fixed": True},
    "理": {"code": "M", "skill": "理線", "skill_no": "FATP03", "tmu_default": 3, "ctq": True},
    "穿": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "滑出螺丝": {"code": "M", "skill": "锁螺丝", "skill_no": "FATP01", "tmu_default": 3, "fixed": True},
    "推": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "拉": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "贴附": {"code": "M", "skill": "貼附", "skill_no": "FATP12", "tmu_default": 3},
    "去除": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "撕除": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "撕开": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "折": {"code": "M", "skill": "理線", "skill_no": "FATP03", "tmu_default": 3, "ctq": True},
    "擦拭": {"code": "M", "skill": "擦拭", "skill_no": "FATP13", "tmu_default": 3},
    "手度": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    "脚步": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 6},
    "旋转": {"code": "M", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    
    # P - Place actions
    "丢": {"code": "P", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "保持住": {"code": "P", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "放": {"code": "P", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "组": {"code": "P", "skill": "裝配", "skill_no": "FATP07", "tmu_default": 3, "ctq": True},
    "复选": {"code": "P", "skill": "一般作业", "skill_no": None, "tmu_default": 1},
    "对准": {"code": "P", "skill": "插金手指", "skill_no": "FATP05", "tmu_default": 3, "ctq": True},
    "插入": {"code": "P", "skill": "插線", "skill_no": "FATP04", "tmu_default": 3, "ctq": True},
    "卡合": {"code": "P", "skill": "卡合", "skill_no": "FATP06", "tmu_default": 3, "ctq": True},
    "施加壓力": {"code": "P", "skill": "一般作业", "skill_no": None, "tmu_default": 3},
    
    # X - Process actions
    "压合": {"code": "X", "skill": "壓合&熱熔", "skill_no": "FATP08", "tmu_default": 6, "ctq": True},
    "热熔": {"code": "X", "skill": "壓合&熱熔", "skill_no": "FATP08", "tmu_default": 6, "ctq": True},
    "点胶": {"code": "X", "skill": "點膠&Bonding", "skill_no": "FATP10", "tmu_default": 6},
    "锁附固定": {"code": "X", "skill": "鎖螺絲", "skill_no": "FATP01", "tmu_default": 6, "fixed": True, "ctq": True},
    "镭雕": {"code": "X", "skill": "半自動/自動化設備操作", "skill_no": "FATP11", "tmu_default": 6},
    "扫描": {"code": "X", "skill": "刷槍", "skill_no": "FATP02", "tmu_default": 3},
    "刷PPID": {"code": "X", "skill": "刷槍", "skill_no": "FATP02", "tmu_default": 3},
    "刷工单二维码": {"code": "X", "skill": "刷槍", "skill_no": "FATP02", "tmu_default": 3},
    "刷条形码": {"code": "X", "skill": "刷槍", "skill_no": "FATP02", "tmu_default": 3},
    "打印": {"code": "X", "skill": "半自動/自動化設備操作", "skill_no": "FATP11", "tmu_default": 0},
    
    # I - Align/Inspect actions
    "并检查": {"code": "I", "skill": "目視", "skill_no": "FATP26", "tmu_default": 1},
    "并确认": {"code": "I", "skill": "目視", "skill_no": "FATP26", "tmu_default": 1},
    "并对准": {"code": "I", "skill": "目視", "skill_no": "FATP26", "tmu_default": 1},
    "并对齐": {"code": "I", "skill": "目視", "skill_no": "FATP26", "tmu_default": 1},
}
...
def derive_most_tmu_from_params(params: Dict[str, Any]) -> int:
    if not params:
        return 0
    tmu_total = 0
    index_keys = {
    ...
    for key, value in params.items():
        if not isinstance(value, (int, float)):
            continue
        if key.upper() in index_keys:
            tmu_total += int(value)
    if params.get("A_dist_cm") is not None:
        tmu_total += lookup_a_tmu(float(params["A_dist_cm"]))
    if params.get("B_angle_deg") is not None:
        tmu_total += lookup_b_tmu(float(params["B_angle_deg"]))
    if params.get("foot_cm") is not None:
        tmu_total += lookup_b_foot_tmu(float(params["foot_cm"]))
    return int(tmu_total * 10)


def generate_index_string(params: Dict[str, Any], seq_type: str, return_a_cm: float = 0) -> str:
    """Generate MiniMOST Index String like 'A1 B0 G1 A3 B0 P1 A0'."""
    if not params:
        return ""
...
def get_preposition(location_type: str, action_verb: Optional[str] = None) -> str:
    """Get appropriate preposition for Chinese sentence generation."""
    from_preps = {
...
def generate_chinese_sentence(
    ...
    """Generate auto Chinese SOP sentence."""
    hand_label = hand or "双手"
    from_prep = get_preposition("from", from_location)
    to_prep = get_preposition("to", action)
    
    sentence = ""
    if from_location and obj and to_location:
        sentence = f"{hand_label} {from_prep}{from_location} 拿取 {obj}，{action} {to_prep}{to_location}"
    elif from_location and obj:
        sentence = f"{hand_label} {from_prep}{from_location} {action} {obj}"
    elif obj and to_location:
        sentence = f"{hand_label} {action} {obj} {to_prep}{to_location}"
    else:
        sentence = f"{hand_label} {action} {obj or ''}"
    
    if is_simo:
        sentence = f"[SIMO] {sentence}"
...
async def calculate_most(request: MOSTCalculateRequest, current_user: dict = Depends(verify_token)):
    ...
    for step in request.steps:
        ...
        derived_tmu = derive_most_tmu_from_params(step.params)
        fixed_tmu = None
        if action_key in FIXED_TMU_VALUES:
    ...
    for i, version in enumerate(db["sop_versions"]):
        if version["id"] == sop_id:
            ...
            if old_status == SOPStatus.DRAFT.value and new_status == SOPStatus.REVIEWED.value:
                ...
                version["reviewed_at"] = datetime.utcnow().isoformat()
