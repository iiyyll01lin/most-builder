...
def test_health_and_db_status_endpoints(client, manager_headers):
    ...
    # PostgresStore returns "sqlite" or "postgresql" as the persistent_file path
    assert isinstance(status.json()["persistent_file"], str)
